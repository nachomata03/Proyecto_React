...
function NavBar() {
  return (
    <div className="flex flex-row items-center h-20 justify-between bg-violet-500">
      <NavLink to="/"><img src={logo} alt="logo de la tienda" style={{width: `80px`, height: `80px`,}}/></NavLink>

      <nav>
      <div>
          <ul className="flex items-center justify-between space-x-64 text-2xl my-3">
        ...
        <div>
          <ul className="flex space-x-44 text-lg pb-5 ">
